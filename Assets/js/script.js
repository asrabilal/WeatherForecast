...
var APIkey = "a095762e35a0e763719aae8dbf0b527f";
...
function currentConditionsRequest(searchValue) {
    ...
    $.ajax({
        ...
        currentWindSpeed.text(response.wind.speed + "MHP");
        ...
        $.ajax({
            ...
            //function getColorCodeForUVindex(UVindex) {
              ...
              //return UVindex.text(response.value);
            //}
        });
